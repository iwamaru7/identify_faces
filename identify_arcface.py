...
# --- 機能フラグ定義 ---
ENABLE_FACE_DIRECTION = False  # 顔の向き認識機能を有効にするかどうか
ENABLE_3D_ARROW_DISPLAY = False  # 3D矢印表示を有効にするかどうか
    ...
    while True:
        ...
        for face in faces:
            ...
            if ENABLE_FACE_DIRECTION:
                ...
                # 顔の向きを3D矢印で表示（フラグが有効な場合のみ）
                if pose is not None and ENABLE_3D_ARROW_DISPLAY:
        ...
        if ENABLE_FACE_DIRECTION:
            if ENABLE_3D_ARROW_DISPLAY:
                window_title = 'Learn (Multiple People with 3D Arrow Direction)'
            else:
                window_title = 'Learn (Multiple People with Direction Info)'
        else:
    ...
    while True:
        ...
        if ENABLE_FACE_DIRECTION:
            if ENABLE_3D_ARROW_DISPLAY:
                ...
                window_title = 'Identify (Multiple People with Direction Info)'
        else:
